...
x_train_adv = fgsm_attack(model, x_train, y_train)
x_train_adv = tf.clip_by_value(x_train_adv, 0.0, 1.0)
x_train_adv = tf.cast(x_train_adv, tf.float32)

# Train the model on the adversarial training set
model.fit(x_train_adv, y_train, epochs=5, batch_size=128, verbose=0)
